...
public class UpdateDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Glide.with(UpdateDetailActivity.this)
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("RentRoomDetail").child(key);
    ...
    public void uploadRentRoomDetailMain(){
        ...
        databaseReference.setValue(roomDataList).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(UpdateDetailActivity.this,"Data Updated",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
